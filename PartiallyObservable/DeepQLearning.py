...
if __name__ == "__main__":
    ...
    env = Lake(filepath='map_2.csv',number_of_agents=num_of_agents,action_type="complete",init_pos=np.array([[11, 12]]),importance_map_path='importance_map_2.csv')
    ...
    for epoch in trange(num_of_epochs):
        ...
        state = env.render(partially = True)
        """ Episode reward """
        episode_reward = 0
